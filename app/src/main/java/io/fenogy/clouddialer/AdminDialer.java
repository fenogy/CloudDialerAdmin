                ...
                public void onClick(View v) {
                    ...
                    if(sendToAgent != null){
                        ...
                        if(!mDuration.getText().toString().equals("")){
                            ...
                            long d = 0;
                            String s = mDuration.getText().toString();

                            try {d = Long.parseLong(s);
                            }catch(NullPointerException e){}


                            if(mSwitch.isChecked()){
                                //SIM2
                                //Only id d is not odd; we add additional one
                                if((d%2 == 0) && (d > 0)){

                                    d = d + 1;
                                    mDuration.setText(String.valueOf(d));
                                }
                            ...
                            Toast.makeText(AdminDialer.this, "Enter correct values to " + mAgent.getText().toString(), Toast.LENGTH_LONG).show();
                        }
